    ...
    >
      ...
      <div className="text-center relative z-10">
        ...
        <div className="mb-12 relative" style={{ perspective: '1000px' }}>
          <div className="text-8xl lg:text-9xl font-bold mb-4 relative animate-3d-rotate">
          ...
          {/* Logo glow effect */}
          <div className="absolute inset-0 text-8xl lg:text-9xl font-bold blur-xl opacity-50 animate-3d-rotate-delayed">
            <span className="text-blue-400">Inno</span>
            <span className="text-red-400">Verse</span>
          </div>
          {/* Additional glow layers */}
          <div className="absolute inset-0 text-8xl lg:text-9xl font-bold blur-2xl opacity-30 animate-3d-rotate-reverse">
        ...
        <div className="relative mb-8">
          ...
          <div className="w-40 h-40 border-4 border-cyan-400/30 rounded-full animate-spin-slow mx-auto relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-6 h-6 bg-gradient-to-r from-cyan-400 via-pink-400 to-purple-400 rounded-full animate-pulse-luxury shadow-lg shadow-cyan-400/50"></div>
              <div className="absolute w-10 h-10 border-2 border-cyan-400/30 rounded-full animate-ping-luxury"></div>
              <div className="absolute w-14 h-14 border border-pink-400/20 rounded-full animate-ping-luxury" style={{ animationDelay: '0.5s' }}></div>
            </div>
          </div>

          {/* Enhanced orbiting elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-6 w-4 h-4 bg-cyan-400 rounded-full animate-orbit-loading shadow-lg shadow-cyan-400/60"></div>
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-6 w-3 h-3 bg-pink-400 rounded-full animate-orbit-loading-reverse shadow-lg shadow-pink-400/60"></div>
            <div className="absolute left-0 top-1/2 transform -translate-x-6 -translate-y-1/2 w-3.5 h-3.5 bg-purple-400 rounded-full animate-orbit-loading-slow shadow-lg shadow-purple-400/60"></div>
            <div className="absolute right-0 top-1/2 transform translate-x-6 -translate-y-1/2 w-2.5 h-2.5 bg-yellow-400 rounded-full animate-orbit-loading-reverse-slow shadow-lg shadow-yellow-400/60"></div>
            {/* Additional orbiting elements */}
            <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400 rounded-full animate-orbit-loading-fast shadow-lg shadow-blue-400/60"></div>
            <div className="absolute bottom-1/4 right-1/4 w-2 h-2 bg-green-400 rounded-full animate-orbit-loading-reverse-fast shadow-lg shadow-green-400/60"></div>
          </div>
        </div>
        ...
        <div className="w-96 mx-auto mb-6">
          ...
          <div className="text-center mt-4 text-blue-300 text-xl font-bold drop-shadow-lg animate-pulse-glow-blue">
            {Math.round(progress)}%
          </div>
        </div>

        {/* Enhanced loading text */}
        <div className="text-blue-300/80 text-lg font-medium drop-shadow-lg animate-pulse-glow-blue">
          {t("loading.initializing")}
        </div>
        <div className="text-sm text-red-300/60 mt-2 animate-pulse-glow-red">
          {t("loading.preparing")}
        </div>
      </div>
