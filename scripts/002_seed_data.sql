-- Seed materials
INSERT INTO public.materials (title, description, category, content, content2, content3, content4, content5, difficulty, duration_minutes) VALUES
('HTML & CSS Basics', 'Learn the fundamentals of web development with HTML and CSS', 'RPL', 'Complete guide to HTML and CSS', NULL, NULL, NULL, NULL, 'Beginner', 120),
('JavaScript Fundamentals', 'Master JavaScript programming language basics', 'RPL', '## MATERI JAVA SCRIPT

### 1. Pengertian JavaScript
JavaScript (JS) adalah bahasa pemrograman tingkat tinggi yang digunakan untuk membuat interaksi dinamis pada halaman web.
Dengan JavaScript, situs web tidak hanya menampilkan teks dan gambar, tetapi juga bisa:
• Menanggapi tindakan pengguna (klik, ketik, scroll)
• Memvalidasi formulir
• Menampilkan animasi
• Mengambil data dari server tanpa memuat ulang halaman (AJAX)
JavaScript berjalan di browser (client-side), namun juga bisa dijalankan di server menggunakan platform seperti Node.js.

### 2. CONTOH KODE JAVA SCRIPT

#### 1. Menampilkan teks di halaman
```javascript
document.write("Halo, Dunia!");
```

#### 2. Menampilkan pesan pop-up (alert)
```javascript
alert("Selamat datang di website saya!");
```

#### 3. Menampilkan pesan di console (alat debugging)
```javascript
console.log("Ini pesan dari JavaScript!");
```

#### 4. Mendefinisikan variabel dan operasi sederhana
```javascript
let a = 10;
let b = 5;
let hasil = a + b;
...
```', '### 3. DOCS JAVA SCRIPT
Berikut situs resmi dan sumber belajar terpercaya JavaScript:

#### 1. 🔗 MDN Web Docs - JavaScript
→ Dokumentasi paling lengkap dan mudah dipahami untuk semua level.

#### 2. 🔗 W3Schools - JavaScript Tutorial
→ Cocok untuk pemula, ada contoh langsung bisa dicoba.

#### 3. 🔗 ECMAScript Official Docs
→ Standar resmi yang digunakan untuk mendefinisikan bahasa JavaScript
...
- **Object**: Objek dengan properti, contoh: {nama: "John", umur: 25}', '### 5. DOM Manipulation
JavaScript dapat memanipulasi HTML melalui DOM:
```javascript
// Mengubah isi elemen
...
JavaScript modern menggunakan Promise dan async/await:
```javascript
// Promise
function fetchData() {
...
```', '### 7. Error Handling
JavaScript memiliki mekanisme error handling yang baik:
```javascript
try {
...
### 8. Modules (ES6)
JavaScript modern menggunakan sistem modul:
```javascript
// math.js
...
console.log(add(5, 3));
```', '### 9. Best Practices
Beberapa praktik terbaik dalam JavaScript:

1. **Gunakan const dan let** daripada var
2. **Hindari global variables** sebisa mungkin
3. **Gunakan strict mode**: `"use strict";`
4. **Validasi input** sebelum diproses
5. **Gunakan descriptive variable names**
6. **Comment kode** yang kompleks
7. **Test kode** secara berkala
8. **Gunakan version control** (Git)
9. **Follow coding standards** (ESLint, Prettier)
10. **Learn continuously** - JavaScript selalu berkembang

### 10. Framework dan Library Populer
- **React**: UI library untuk web
- **Vue.js**: Progressive framework
- **Angular**: Full-featured framework
- **Node.js**: JavaScript di server
- **Express.js**: Web framework untuk Node.js
- **jQuery**: Library untuk DOM manipulation (legacy)

### Kesimpulan
JavaScript adalah bahasa pemrograman yang powerful dan fleksibel. Dengan memahami konsep-konsep dasar seperti variabel, fungsi, kondisi, perulangan, dan DOM manipulation, Anda sudah memiliki fondasi yang kuat untuk membangun aplikasi web yang interaktif. Teruslah belajar dan praktikkan setiap hari!', 'Beginner', 150),
('React Framework', 'Build modern UIs with React', 'RPL', 'React components, hooks, and state management', NULL, NULL, NULL, NULL, 'Intermediate', 180),
('Database Design', 'Learn database design and SQL', 'RPL', 'Database concepts and SQL queries', NULL, NULL, NULL, NULL, 'Intermediate', 140),
('Python for AI', 'Introduction to Python for AI and Machine Learning', 'RPL', 'Python basics and ML libraries', NULL, NULL, NULL, NULL, 'Intermediate', 160),
('Web Security', 'Secure your web applications', 'RPL', 'Security best practices and common vulnerabilities', NULL, NULL, NULL, NULL, 'Advanced', 120),
('Design Principles', 'Learn fundamental design principles and tools', 'DKV', '## MATERI DESAIN GRAFIS DASAR
...
- **Alignment**: Rata kiri, kanan, tengah, justify', '### 6. Komposisi dan Layout
...
- **Sustainability**: Desain ramah lingkungan', '### 11. Tools dan Resources
...
### Kesimpulan
Desain grafis adalah kombinasi seni dan teknologi. Dengan memahami elemen, prinsip, dan tools desain, Anda dapat menciptakan karya visual yang komunikatif dan menarik. Teruslah berlatih, ikuti tren terkini, dan bangun portfolio yang kuat untuk karir di bidang desain grafis.', NULL, NULL, NULL, 'Beginner', 130),
('Computer Networking', 'Understanding computer networks and telecommunications', 'TKJ', '## MATERI JARINGAN KOMPUTER
...
- **Network Access Layer**: Ethernet, WiFi, PPP', '### 7. IP Addressing
...
- **Software Defined Networking (SDN)**', '### 13. Network Administration
...
### Kesimpulan
Jaringan komputer adalah fondasi dari dunia digital modern. Memahami konsep-konsep dasar networking, protokol, keamanan, dan troubleshooting akan membekali Anda dengan keterampilan yang sangat dibutuhkan di era digital ini. Teruslah belajar dan praktikkan konfigurasi jaringan untuk mengembangkan karir di bidang teknologi informasi.', NULL, NULL, NULL, 'Intermediate', 140),
('Telecommunications Systems', 'Learn about telecommunication systems and technologies', 'TRANS/TELKO', '## MATERI TELEKOMUNIKASI
...
- **Broadband Internet**
- **Cable TV Networks**
- **Satellite Communications**', '### 6. Signal Processing
...
- **NFC**: Near Field Communication', '### 12. Telekomunikasi Digital
...
### Kesimpulan
Telekomunikasi adalah bidang yang terus berkembang pesat dengan teknologi baru seperti 5G, fiber optic, dan satelit. Memahami prinsip-prinsip dasar, teknologi modern, dan tren masa depan akan membekali Anda dengan pengetahuan yang komprehensif di bidang telekomunikasi. Industri ini menawarkan peluang karir yang luas di era digital saat ini.', NULL, NULL, NULL, 'Advanced', 160);

-- Seed quizzes
INSERT INTO public.quizzes (title, description, total_questions, passing_score, category) VALUES
('HTML Basics Quiz', 'Test your HTML knowledge', 10, 70, 'RPL'),
('JavaScript Quiz', 'Test your JavaScript knowledge', 15, 70, 'RPL'),
('React Quiz', 'Test your React knowledge', 12, 75, 'RPL'),
('Design Principles Quiz', 'Test your design principles knowledge', 15, 70, 'DKV'),
('Computer Networking Quiz', 'Test your networking knowledge', 15, 70, 'TKJ'),
('Telecommunications Quiz', 'Test your telecommunications knowledge', 15, 70, 'TRANS'),
('Database Design Quiz', 'Test your database design knowledge', 15, 70, 'RPL');

-- Seed achievements
INSERT INTO public.achievements (name, description, criteria) VALUES
('First Steps', 'Complete your first material', 'Complete 1 material'),
('Quick Learner', 'Complete 5 materials', 'Complete 5 materials'),
('Master Student', 'Complete 10 materials', 'Complete 10 materials'),
('Quiz Champion', 'Pass 5 quizzes', 'Pass 5 quizzes'),
('Perfect Score', 'Get 100% on a quiz', 'Score 100% on any quiz'),
('Consistent Learner', 'Learn for 7 consecutive days', 'Learn for 7 consecutive days');
